...
const benefits = [
  {
    ...
    description: "Oferecemos os melhores preços do mercado e pagamento imediato após a coleta.",
    color: "#FCBE1D",
  },
  {
    icon: Leaf,
    title: "Sustentabilidade garantida",
    description: "Todo material é reciclado de forma consciente, preservando o meio ambiente.",
    color: "#4CAF50",
  },
  {
    icon: TruckIcon,
    title: "Coleta rápida",
    description: "Logística eficiente para buscar sua sucata no menor tempo possível.",
    color: "#F54337",
  },
  {
    icon: FileText,
...
export function BenefitsSection() {
  ...
  return (
    <section id="benefits" className="py-20 relative overflow-hidden">
      {/* Gradient Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#157EC2] via-[#1a5d8f] to-[#F54337]"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div ref={ref} className="text-center mb-16">
          ...
          >
            Por que escolher o <span className="text-[#FCBE1D]">Sucatão Forte?</span>
          </h2>
          <p

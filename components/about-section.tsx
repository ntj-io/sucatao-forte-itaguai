    ...
    <section id="about" className="py-20 bg-[#F9F9F9]">
      <div className="container mx-auto px-4">
        <div ref={ref} className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#222222]">
            ...
            <div className="grid gap-4">
              {[
                ...
                >
                  ...
                  <span className="font-semibold text-lg text-[#222222]">{item.text}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img
                src="/scrap-metal-recycling-yard-with-trucks-and-workers.jpg"
                alt="Pátio do Sucatão Forte"
                className="w-full h-[500px] object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#157EC2]/60 to-transparent"></div>
            </div>
            {/* Decorative Elements */}
